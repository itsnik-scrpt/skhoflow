    ...
    <div className="min-h-screen flex" style={{ background: 'var(--bg)' }}>
      ...
      <div className="hidden lg:flex flex-col justify-between w-[44%] p-12 relative overflow-hidden"
        ...
        <div className="absolute top-0 right-0 w-[500px] h-[500px] pointer-events-none"
          style={{ background: 'radial-gradient(circle at 70% 20%, rgba(220,38,38,0.15) 0%, transparent 60%)' }} />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] pointer-events-none"
          style={{ background: 'radial-gradient(circle at 30% 80%, rgba(234,179,8,0.1) 0%, transparent 60%)' }} />
        ...
        <div>
          <p className="text-4xl font-bold leading-snug mb-4" style={{ color: 'var(--text-1)', fontFamily: 'Nunito, sans-serif' }}>
            {t('auth.leftPanel.line1')}
          </p>
          <p className="text-sm" style={{ color: 'var(--text-3)' }}>{t('auth.leftPanel.sub')}</p>
        </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <motion.div
          ...
          <div className="mb-8">
            ...
            <p className="text-sm" style={{ color: 'var(--text-3)' }}>{t('auth.login.sub')}</p>
          </div>
